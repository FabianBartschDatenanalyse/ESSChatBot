...
const chartExamples = [
    'Create a multi-line chart comparing trust in government over time for the top five countries.',
    'Generate a stacked bar chart that shows employment status by gender across regions.',
    'Build a scatter plot mapping life satisfaction against income, color-coded by education level.',
    'Visualize a heatmap of civic participation frequency across age group and education level.',
    'Produce a donut chart displaying respondents\' preferred sources of political news.',
];
        ...
        <div className='space-y-4'>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Highlight trends with line, bar, scatter, heatmap, and donut charts.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <ul className='list-disc space-y-2 pl-5'>
                        {chartExamples.map((prompt, index) => (
                            <li key={index}><code className='font-mono text-sm'>{prompt}</code></li>
                        ))}
                    </ul>
                </CardContent>
