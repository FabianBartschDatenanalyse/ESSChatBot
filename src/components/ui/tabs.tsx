...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center gap-1 rounded-full bg-secondary/40 p-1 text-sm text-muted-foreground backdrop-blur",
      className
    )}
    {...props}
  />
